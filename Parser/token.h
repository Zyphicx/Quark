...
enum TokenType {UNDEFINED, NUMBER, IDENTIFIER, STRING_CONST, DOUBLE, ELSE, FOR, IF, INCLUDE, INTEGER, LIST, RETURN, STRING, TUPLE, WHILE,
				...
				EQUALS_EQUALS, AMPER_AMPER, VBAR_VBAR, PLUS_PLUS, MINUS_MINUS, PREPROCESSOR, OPTIONAL, OR, LOOP, MACRO};
