...
enum token_type {NUMBER, IDENTIFIER, STRING, ADD, SUBTRACT, MULTIPLY, DIVIDE, MODULO, EXPONENT,
	GREATER, LESS, GREATER_EQUALS, LESS_EQUALS, NOT, NOT_EQUALS, AMPER, AND, VBAR, OR, ASSIGN, ADD_ASSIGN, 
	SUBTRACT_ASSIGN, MULTIPLY_ASSIGN, DIVIDE_ASSIGN, MODULO_ASSIGN, EXPONENT_ASSIGN, EQUALS, INCREMENT, DECREMENT,
